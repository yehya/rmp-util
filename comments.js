...
CommentArea.prototype.injectContent = function(imageURL,rating,commentText,footerText,tagText){
	$(this.singleComment.commentsImage).attr('src', imageURL);
	$(this.singleComment.contentHeader).text(rating);
	$(this.singleComment.middleContent).text(commentText);
	$(this.singleComment.contentBottom).text(footerText);
	$(this.singleComment.tag).text(tagText);
