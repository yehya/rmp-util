var rmpUtility = function(){
   
   /**
    * Sources for Smilebox, chili images, and comment images in base64 code
    *
    */
    var IMAGE_SRC = {};
     ...
     */
    HOTNESS_IMAGES = [
        '<img class="chili-background" src="' + IMAGE_SRC.COLD_CHILI + '">',
        '<img class="chili-background" src="' + IMAGE_SRC.WARM_CHILI + '">',
        '<img class="chili-background" src="' + IMAGE_SRC.STEAMY_CHILI + '">',
        '<img class="chili-background" src="' + IMAGE_SRC.SCORCHING_CHILI + '">'
    ];
    ...
    var formatProfAttr = function(profAttr) {
        if (String(+profAttr).charAt(0) == profAttr) return profAttr + '.0';
        else return profAttr;
    };
    ...
    var getColor = function(rating) {
        // Holds all of the linear gradients
        var BAR_COLOR_STYLES = ['linear-gradient(to right, #b51b58 0%, #ef2e72 100%)',
        'linear-gradient(to right, #ff9c00 0%, #ffd42b 100%)',
        'linear-gradient(to right, #849c1b 0%, #c8e744 100%)'];
        ...
        // Determines if ratings are numbers,
